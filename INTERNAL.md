...
- Lines 11889: Flask routes start — `/` serves HTML, `/og-preview.png` serves branded preview
- Lines 11889-15128: All API route handlers (58 endpoints + og-preview)
- Lines 15130-15266: Startup — argument parsing, preload, rescan thread, server launch
