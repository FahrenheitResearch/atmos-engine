...
- Lines 11728: Flask routes start — `/` serves HTML, `/og-preview.png` serves branded preview
- Lines 11728-14965: All API route handlers (58 endpoints + og-preview)
- Lines 14967-15105: Startup — argument parsing, preload, rescan thread, server launch
