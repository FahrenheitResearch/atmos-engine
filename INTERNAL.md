...
- Lines 11791: Flask routes start — `/` serves HTML, `/og-preview.png` serves branded preview
- Lines 11791-15028: All API route handlers (58 endpoints + og-preview)
- Lines 15030-15168: Startup — argument parsing, preload, rescan thread, server launch
