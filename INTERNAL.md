...
- Lines 11780: Flask routes start — `/` serves HTML, `/og-preview.png` serves branded preview
- Lines 11780-15017: All API route handlers (58 endpoints + og-preview)
- Lines 15019-15157: Startup — argument parsing, preload, rescan thread, server launch
