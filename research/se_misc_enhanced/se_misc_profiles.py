"""
Southeast, Black Hills, Midwest & Hawaii — Enhanced Fire-Vulnerable City Profiles
==================================================================================

Research-paper-quality profiles for 25 fire-vulnerable cities across 8 states.
Excludes bastrop_tx (moved to Southern Plains profiles).

Regions covered:
    HAWAII (4 cities): Lahaina, Kula, Wailea/Kihei, Waimea
    TENNESSEE (3 cities): Gatlinburg, Pigeon Forge, Crossville
    NORTH CAROLINA (4 cities): Asheville, Bryson City, Lake Lure, Blowing Rock, Boone
    GEORGIA (1 city): Athens
    FLORIDA (1 city): Panama City
    SOUTH DAKOTA (7 cities): Rapid City, Custer, Deadwood, Hot Springs, Spearfish,
                             Keystone, Hill City, Sturgis
    MISSOURI (2 cities): Branson, Hollister/Table Rock Lake
    MINNESOTA (1 city): Duluth

Key events:
    - Lahaina, HI (2023): 102 killed, 2,207 structures — deadliest US wildfire in 100+ yrs
    - Gatlinburg, TN (2016): 14 killed, 2,400+ structures — Chimney Tops 2 Fire
    - Jasper Fire (2000): 83,508 acres — largest Black Hills fire ever
    - Grizzly Gulch Fire (2002): 11,500 acres threatening Deadwood/Lead
    - Legion Lake Fire (2017): 53,875 acres in Custer State Park / Wind Cave NP
    - 2016 SE Appalachian drought fires: 119,000+ acres across 7 states
    - Mana Road Fire (2021): 42,000+ acres on Parker Ranch, Big Island
    - Greenwood Fire (2021): 26,800 acres, 70+ structures, Superior NF

Sources:
    - USFA/FEMA 2023 Maui Wildfire After-Action Report
    - NIST Chimney Tops 2 Fire investigation
    - USGS Jasper Fire fuels data (2023-2024 collections)
    - SD Wildland Fire Division historical records
    - NCFS wildfire statistics
    - Hawaii DLNR fire records
...
SE_MISC_ENHANCED = {
    ...
    # =========================================================================
    # SOUTH DAKOTA — BLACK HILLS (7 cities)
    # =========================================================================
