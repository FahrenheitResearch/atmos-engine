"""
Southern Plains Fire-Vulnerable City Profiles — Research-Paper Quality
======================================================================
Enhanced profiles for 28 cities across Texas, Oklahoma, and Kansas with
significant wildfire vulnerability. Covers terrain, historical fires,
evacuation routes, infrastructure, demographics, and fire spread
characteristics at depth suitable for academic/research use.

Southern Plains fire season is predominantly WINTER (Nov-Mar), driven by
dormant grass curing (90-100% cured native grass), dryline dynamics,
post-frontal wind shifts, and low relative humidity. Cold front passages
produce the most dangerous fire weather: pre-frontal southwest winds shift
to northwest at 40-70 mph with single-digit RH, creating explosive grass
fire runs across flat to rolling terrain.

Key fire weather mechanisms:
- Dryline: sharp moisture boundary (dewpoint drop of 30F+ in miles) sets up
  across TX Panhandle/western OK/KS; afternoon mixing can push dryline east
  and ignite fires at the boundary
- Post-frontal winds: cold fronts arrive with 50-70 mph gusts, 5-15% RH,
  and shift wind direction 90-180 degrees, causing flank-to-head fire runs
- Dormant grass curing: native shortgrass/mixed-grass prairies reach 90-100%
  cured by December; continuous fine fuels across millions of acres
- Utility ignitions: wind-damaged power lines are the #1 ignition source for
  megafires (Smokehouse Creek, East Amarillo Complex, Starbuck, Bastrop)

Sources: Texas A&M Forest Service, Kansas Forest Service, Oklahoma Forestry
Services, InciWeb, NIFC, US Census Bureau, NOAA SPC/WPC, peer-reviewed
literature on Southern Plains fire climatology, local journalism.
